    ...
    <div className="w-full h-full px-12 mt-9">
      ...
      <div className="flex border-2 shadow-sm rounded-lg mt-7">
          ...
          {addedUsers.length > 0 && (
            <>
              <div className=" border-b pb-2">
                ...
                <span className=" px-1 bg-gray-100 rounded-full text-xs">
                  {addedUsers.length}
                </span>
              </div>
        ...
        <form className="flex-[1.4] px-10 pt-8 pb-5">
          ...
          <input
            type="text"
            className="w-full border shadow-sm rounded-md py-3 px-4 mt-4 mb-6"
            placeholder="Enter Name"
            onChange={(e) => setName(e.target.value)}
          />
          <label htmlFor="" className=" font-semibold">
            Description<span className=" opacity-40">(Required)</span>
          </label>
          <input
            type="text"
            className="w-full border shadow-sm rounded-md py-3 px-4 mt-4 mb-6"
          ...
          />
          <label htmlFor="" className=" font-semibold">
            Add Member<span className=" opacity-40">(Optional)</span>
          </label>
          <input
            type="text"
            className="w-full border shadow-sm rounded-md py-3 px-4 mt-4 mb-6"
          ...
          <div className=" mt-8 w-full flex justify-end gap-4">
            ...
            <button
              className={`py-3 px-8 ${
                creating ? "bg-[#5292ebe5]" : "bg-[#1570EFE5]"
