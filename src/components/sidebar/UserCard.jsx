...
function UserCard({settings}) {
  return (
    <div className={`${settings ? `bg-[#ffffff] w-[346px] h-[100px] gap-4 mt-20` : `bg-[#EDEDED] w-[300px] h-[100px] justify-between mt-9`} rounded-xl mx-auto flex items-center cursor-pointer`}>
        ...
        {!settings && 
          <Link to='/sidebar/settings'>
            <img src={gear} alt="User Profile" className='w-[24px] h-[25px] object-contain mr-[10px]'/>
          </Link>}
    </div>
  )
}
