  ...
  return (
    <div className='w-full lg:h-[746px] bg-gradient-to-b from-[#BAAEAB] to-[#F8F7F7]'>
        <div className='w-full px-7 lg:px-24 flex flex-col text-center'>
            <h1 className='w-full font-semibold text-4xl lg:text-7xl mt-10 lg:mt-32'>Connect, <span className='text-white'>Grow</span> and Inspire.</h1>
        ...
        <div className='md:w-7/12 max-w-[748px] h-44 lg:h-80 mx-auto mt-5 flex justify-between'>
            <div className='w-[48%] h-28 md:h-52 lg:h-60 relative'>
              ...
              <div className='text-white w-32 lg:w-48 lg:h-7 flex justify-between absolute -right-5 top-10 md:right-0 md:top-16'>
            ...
            <div className='w-[48%] h-28 md:h-52 lg:h-60 relative flex flex-row-reverse mt-auto'>
              ...
              <div className='text-white w-32 lg:w-48 lg:h-7 absolute -left-5 top-8 md:left-0 md:top-14 flex flex-row-reverse justify-between'>
