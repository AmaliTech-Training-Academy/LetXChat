  ...
  return (
    <div className='w-full h-[746px] bg-gradient-to-b from-[#BAAEAB] to-[#F8F7F7]'>
        <div className='w-full px-24 flex flex-col text-center'>
            <h1 className='w-full font-semibold text-7xl mt-10 lg:mt-32'>Connect, <span className='text-white'>Grow</span> and Inspire.</h1>
            <span className='w-92 lg:w-[969px] font-semibold text-3xl mt-5 mx-auto text-[#0000007f]'>Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.</span>
        ...
        <div className='w-7/12 max-w-[748px] w- h-80 mx-auto mt-5 flex justify-between'>
            <div className='w-[48%] h-60 relative'>
              ...
              <div className='text-white w-32 lg:w-48 lg:h-7 flex justify-between absolute right-0 top-16'>
                ...
                <div className='text-white w-24 lg:w-36 bg-[#BAAEAB] text-[4.8px] lg:text-[7.8px] flex items-center justify-center rounded-xl'>
            ...
            <div className='w-[48%] h-60 relative flex flex-row-reverse mt-auto'>
              ...
              <div className='text-white w-32 lg:w-48 lg:h-7 absolute left-0 top-14 flex flex-row-reverse justify-between'>
                <div className='w-5 h-5 lg:w-7 lg:h-7 bg-[#755D57E5] rounded-full flex items-center justify-center relative text-xs'>
                  <span>TA</span>
                  <div className='w-1 h-1 bg-[#42F053] rounded-full absolute right-0 bottom-1.5'></div>
                </div>
                <div className='text-white w-24 lg:w-36 bg-[#5C98F1] text-[4.8px] lg:text-[7.8px] flex items-center justify-center rounded-xl'>
